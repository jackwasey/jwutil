...
For functions where the first argument is a vector, and the order of elements in the vector should not matter, `expect_that_combine_first_arg` will permute all combinations of the first argument, and expect the same result. A large number of elements will take a very long time.
```{r combine_first}
expect_that_combine_first_arg(sum(extreme_numbers), testthat::equals(0))
```
